...
Later, the componentDidUpdate method is used after the component is updated in the DOM.  we can use some statements checking if the component is updating like using prevState is the arguments 
